...
class ZmcmsMainServiceProvider extends ServiceProvider{
	...
	public function boot(){
		...
		$this->publishes([
			...
			__DIR__.'/frontend/less' => base_path('public/themes/zmcms/frontend/less'),
			__DIR__.'/frontend/metadata' => base_path('public/themes/zmcms/frontend/metadata'),
			__DIR__.'/frontend/scss' => base_path('public/themes/zmcms/frontend/scss'),
			__DIR__.'/frontend/sprites' => base_path('public/themes/zmcms/frontend/sprites'),
			__DIR__.'/frontend/svgs' => base_path('public/themes/zmcms/frontend/svgs'),
			__DIR__.'/frontend/webfonts' => base_path('public/themes/zmcms/frontend/webfonts'),
			__DIR__.'/backend/js' => base_path('public/themes/zmcms/backend/js'),
			__DIR__.'/frontend/js' => base_path('public/themes/zmcms/frontend/js'),
			__DIR__.'/frontend' => base_path('public/themes/zmcms/frontend'),
